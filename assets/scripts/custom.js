    ...
    $('div.treeWrap div.uc-container').each(function (i) {
        ...
        $item.find('img').on('click', function () {
            if (!opened) {
                ...
                if ($item.hasClass('videoTET')) {
                    musicOnOff(false);
                    $item.find('iframe').attr('src', '//www.youtube.com/embed/Z20My1U18As');
                }
                if ($item.hasClass('videoNOEL')) {
                    musicOnOff(false);
                    $item.find('iframe').attr('src', '//www.youtube.com/embed/FgvQ_ctcS1A');
                }
            }
